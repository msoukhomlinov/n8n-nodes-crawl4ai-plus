...
- `extractData` Locations & Addresses: `sourceSnippet` field added to LLM schema — each extracted location must provide the verbatim text it was drawn from; snippet is verified against page content to catch and discard hallucinated addresses
