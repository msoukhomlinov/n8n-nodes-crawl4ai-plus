...
### Added
- Two complementary integrity checks that convert the deep, opaque `MODULE_NOT_FOUND` from a corrupted nested-dependency install (`axios`, `zod`, `libphonenumber-js`) into a clear, actionable "nested dependency install is corrupted — reinstall this package's deps" message (#27):
